...
/* import openForm from './script/openForm'; */
function Home() {
      ...
      <main>
        <div className="container">
          ...
          <div className="groupTrunks">
            <div className="trunksContainter">
              ...
              <g id="Camada_2" data-name="Camada 2">
                <g id="Camada_2-2" data-name="Camada 2">
                  <g id="Camada_6" data-name="Camada 6">
                    ...
                    <path d="M184.14,570.65a7.53,7.53,0,0,1-3.4-.82,8.66,8.66,0,0,1-4.57-7.77V485.92c0-4.75,3.57-8.59,8-8.59s8,3.84,8,8.59v58l8-7.1c28.75-25.34,51.46-45.35,74.34-69.11a7.57,7.57,0,0,1,11.27.22,9.05,9.05,0,0,1-.2,12.14c-23.35,24.25-46.28,44.46-75.31,70-6.71,5.92-13.7,12.08-21.05,18.61A7.66,7.66,0,0,1,184.14,570.65Z"/>
          ...
          <div className="conversionContainer">
            <div className="conversion">
              <h2>Não sinta mais dificuldade em meio digital com a coruja.</h2>
